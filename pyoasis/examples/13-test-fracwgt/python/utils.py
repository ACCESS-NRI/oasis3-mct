...
def write_namcouple(sgrid, dgrid, has_graphics):
    ...
    if has_graphics:
        print("FSENDSCA:FSENDWGT FRECVSCA:FRECVWGT 1 7200 1 rst.nc EXPORTED", file=namcouple)
    else:
        print("FSENDSCA:FSENDWGT FRECVSCA:FRECVWGT 1 7200 1 rst.nc EXPOUT", file=namcouple)
    ...
    print("############################################", file=namcouple)
    if has_graphics:
        print("FSENDNOR FRECVNOR 1 7200 1 rst.nc EXPORTED", file=namcouple)
    else:
        print("FSENDNOR FRECVNOR 1 7200 1 rst.nc EXPOUT", file=namcouple)
    print("{} {} {} {} {} {}".format(grid_shape(sgrid)[0], grid_shape(sgrid)[1],
                                     grid_shape(dgrid)[0], grid_shape(dgrid)[1],
                                     sgrid, dgrid), file=namcouple)
    print("{} {} {} {}".format(grid_perio(sgrid)[0], grid_perio(sgrid)[1],
