...
for var in ${StringArrayv1[@]}; do
	cp ${SCRATCHDIR}/oasis3-mct/util/env_tests/oasis_test_build.sh ${SCRATCHDIR}/oasis3-mct_tests/$var/.
	cp ${SCRATCHDIR}/oasis3-mct/util/env_tests/oasis_test_run.sh ${SCRATCHDIR}/oasis3-mct_tests/$var/.
done
