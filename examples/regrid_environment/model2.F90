...
PROGRAM model2
   ...
   INTEGER :: local_comm  ! local MPI communicator and Initialized
   ...
   INTEGER                       :: var_sh(1) ! local dimensions of the arrays; 2 x rank (=4)
   ...
   ENDIF
   !
   ! Only the master process participate in the coupling
   IF (mype == 0) THEN
     !
     !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     !  GRID DEFINITION 
     !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     !
     ! Read global grids.nc and masks.nc files
     ! For simplicity, all processes read the whole grid
     ! Get arguments giving target grid acronym
     !
     ...
     !
     !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     !  PARTITION DEFINITION (master process treats the whole coupling field) 
     !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ !
     !
     il_size = 3
   ...
   ENDIF
   !
   ! Only the master process participates in the coupling
   IF (mype == 0) THEN
     !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     ! For simplicity, only the master process receives the whole field
     !
     ...
     !
#ifdef FANA1
     CALL function_ana1(nlon, nlat, gg_lon, gg_lat, field_ana)
#elif defined FANA2
     CALL function_ana2(nlon, nlat, gg_lon, gg_lat, field_ana)
#elif defined FANA3
     CALL function_vortex(nlon, nlat, gg_lon, gg_lat, field_ana)
#endif
     !
     ...
     IF (file_debug) THEN
         ...
         WRITE(w_unit,'(A60,1X,F6.4)') 'Error mean on non masked points that received a value (%): ', SUM(ABS(gg_error), MASK=mask_error>0)/ic_nmskrv
     ...
     !
   ENDIF ! Only master process participates in the coupling 
   !
   !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   !         TERMINATION 
   !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
