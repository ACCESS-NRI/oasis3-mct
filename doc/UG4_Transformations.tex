...
\item {\bf SCRIPR}:
  ...
  option, for {\tt CONSERV} only (i.e. {\tt DESTAREA}, {\tt DESTARTR}, {\tt FRACAREA}, {\tt FRACARTR},  {\tt FRACNNEI} or {\tt FRACNNTR}, see below). One has to take care that the
...
\end{verbatim}
 ...
 \begin{enumerate}
  ...
  \item If a target grid cell intersects only masked source cells, or falls outside the source grid domain, it
    will get a zero value unless the {\tt FRACNNEI} or {\tt FRACNNTR}
