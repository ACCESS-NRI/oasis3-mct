...
\end{verbatim}
    ...
    neighbour fill is done ({\tt ll\_nnei} is set to {\tt .false} in the SCRIP run). Non-masked target grid points that do not
    receive any interpolated value are set to 0 .
...
\end{verbatim}
 ...
 \begin{enumerate}
  ...
  \item Masked target grid cells are set to 0.
