...
\item {\bf SCRIPR}:
  ...
  option, for {\tt CONSERV} only (i.e. {\tt DESTAREA}, {\tt DESTARTR}, {\tt DESTNNEI} {\tt DESTNNTR}, {\tt FRACAREA}, {\tt FRACARTR},  {\tt FRACNNEI} or {\tt FRACNNTR}, see below). One has to take care that the
  ...
  \item {\tt DISTWGT} performs a distance weighted nearest-neighbour
    interpolation (N neighbours) with a nearest neighbor fill for unset target points. 
    All types of grids are supported.

  \item {\tt DISTWGTNF} performs a distance weighted nearest-neighbour
    interpolation (N neighbours) WITHOUT the nearest neighbor fill for unset target points. 
    All types of grids are supported.
...
\end{verbatim} 
  ...
  \item {\tt GAUSWGT} performs a N nearest-neighbour interpolation
    ...
    unset target points. All grid types are supported.
...
\end{verbatim}
  ...
  \item {\tt BILINEAR} performs an interpolation based on a local
    ...
    interpolation for unset target points with a nearest neighbor fill.
  ...
  \item {\tt BICUBIC} performs an interpolation based on a local
    ...
    unset target points with a nearest neighbor fill.
