...
``UNUSED'' and not fully described.
...
are described in section \ref{sec_transformations}. A realistic {\it
  ...
  oasis3-mct/examples/spoc/spoc\_communication/data\_spoc} directory.
...
The third number (new in OASIS3-MCT\_5.0) can be set to 1 to activate a {\bf load balancing} diagnostic.
...
\item {\tt \$NCDFTYP}: Optional (new in OASIS3-MCT\_5.0); on the line below
  ...
  directive {\tt CDF\_64BIT\_DATA} be used when compiling OASIS3-MCT.  
