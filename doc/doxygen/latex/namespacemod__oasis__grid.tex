...
\begin{DoxyCompactList}\small\item\em Generic interface to support writing 4 or 8 byte reals. \end{DoxyCompactList}\item 
interface \hyperlink{interfacemod__oasis__grid_1_1oasis__write__frac}{oasis\+\_\+write\+\_\+frac}
\begin{DoxyCompactList}\small\item\em Generic interface to support writing 4 or 8 byte reals. \end{DoxyCompactList}\item 
...
subroutine, public \hyperlink{namespacemod__oasis__grid_ae8c451c5d0190f1077107419283d2a6a}{oasis\+\_\+write\+\_\+mask} (cgrid, nx, ny, mask, partid, companion)
...
subroutine \hyperlink{namespacemod__oasis__grid_acf5aadf5df317f065c5ced3de9662aac}{oasis\+\_\+write\+\_\+frac\+\_\+r8} (cgrid, nx, ny, frac, partid, companion)
\begin{DoxyCompactList}\small\item\em User interface to set frac values for 8 byte reals. \end{DoxyCompactList}\item 
subroutine \hyperlink{namespacemod__oasis__grid_ac6cd6ea8952c6e6df18a80d36c1f95f9}{oasis\+\_\+write\+\_\+frac\+\_\+r4} (cgrid, nx, ny, frac, partid, companion)
\begin{DoxyCompactList}\small\item\em User interface to set frac values for 4 byte reals. \end{DoxyCompactList}\item 
...
Definition at line 1402 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 1452 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 173 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 235 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 972 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
\item Gather fracs if needed and write from root
\item Gather angles if needed and write from root
\item Gather masks if needed and write from root 
\end{DoxyItemize}
\end{DoxyItemize}

Definition at line 1005 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 475 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 417 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 791 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 732 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 602 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 532 of file mod\+\_\+oasis\+\_\+grid.\+F90.

\mbox{\Hypertarget{namespacemod__oasis__grid_ac6cd6ea8952c6e6df18a80d36c1f95f9}\label{namespacemod__oasis__grid_ac6cd6ea8952c6e6df18a80d36c1f95f9}} 
\index{mod\+\_\+oasis\+\_\+grid@{mod\+\_\+oasis\+\_\+grid}!oasis\+\_\+write\+\_\+frac\+\_\+r4@{oasis\+\_\+write\+\_\+frac\+\_\+r4}}
\index{oasis\+\_\+write\+\_\+frac\+\_\+r4@{oasis\+\_\+write\+\_\+frac\+\_\+r4}!mod\+\_\+oasis\+\_\+grid@{mod\+\_\+oasis\+\_\+grid}}
\subsubsection{\texorpdfstring{oasis\+\_\+write\+\_\+frac\+\_\+r4()}{oasis\_write\_frac\_r4()}}
{\footnotesize\ttfamily subroutine mod\+\_\+oasis\+\_\+grid\+::oasis\+\_\+write\+\_\+frac\+\_\+r4 (\begin{DoxyParamCaption}\item[{character(len=$\ast$), intent(in)}]{cgrid,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in)}]{nx,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in)}]{ny,  }\item[{real(kind=ip\+\_\+single\+\_\+p), dimension(\+:,\+:), intent(in)}]{frac,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in), optional}]{partid,  }\item[{character(len=$\ast$), intent(in), optional}]{companion }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
\mbox{\tt in}  & {\em ny} & global ny size\\
\hline
\mbox{\tt in}  & {\em frac} & fracs\\
\hline
\mbox{\tt in}  & {\em partid} & partition id if nonglobal data\\
\hline
\mbox{\tt in}  & {\em companion} & companion grid name \\
\hline
\end{DoxyParams}


Definition at line 909 of file mod\+\_\+oasis\+\_\+grid.\+F90.

\mbox{\Hypertarget{namespacemod__oasis__grid_acf5aadf5df317f065c5ced3de9662aac}\label{namespacemod__oasis__grid_acf5aadf5df317f065c5ced3de9662aac}} 
\index{mod\+\_\+oasis\+\_\+grid@{mod\+\_\+oasis\+\_\+grid}!oasis\+\_\+write\+\_\+frac\+\_\+r8@{oasis\+\_\+write\+\_\+frac\+\_\+r8}}
\index{oasis\+\_\+write\+\_\+frac\+\_\+r8@{oasis\+\_\+write\+\_\+frac\+\_\+r8}!mod\+\_\+oasis\+\_\+grid@{mod\+\_\+oasis\+\_\+grid}}
\subsubsection{\texorpdfstring{oasis\+\_\+write\+\_\+frac\+\_\+r8()}{oasis\_write\_frac\_r8()}}
{\footnotesize\ttfamily subroutine mod\+\_\+oasis\+\_\+grid\+::oasis\+\_\+write\+\_\+frac\+\_\+r8 (\begin{DoxyParamCaption}\item[{character(len=$\ast$), intent(in)}]{cgrid,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in)}]{nx,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in)}]{ny,  }\item[{real(kind=ip\+\_\+double\+\_\+p), dimension(\+:,\+:), intent(in)}]{frac,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in), optional}]{partid,  }\item[{character(len=$\ast$), intent(in), optional}]{companion }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
Definition at line 848 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 349 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 280 of file mod\+\_\+oasis\+\_\+grid.\+F90.

\mbox{\Hypertarget{namespacemod__oasis__grid_ae8c451c5d0190f1077107419283d2a6a}\label{namespacemod__oasis__grid_ae8c451c5d0190f1077107419283d2a6a}} 
...
{\footnotesize\ttfamily subroutine, public mod\+\_\+oasis\+\_\+grid\+::oasis\+\_\+write\+\_\+mask (\begin{DoxyParamCaption}\item[{character(len=$\ast$), intent(in)}]{cgrid,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in)}]{nx,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in)}]{ny,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), dimension(\+:,\+:), intent(in)}]{mask,  }\item[{integer(kind=ip\+\_\+intwp\+\_\+p), intent(in), optional}]{partid,  }\item[{character(len=$\ast$), intent(in), optional}]{companion }\end{DoxyParamCaption})}
...
Definition at line 671 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 158 of file mod\+\_\+oasis\+\_\+grid.\+F90.
...
Definition at line 157 of file mod\+\_\+oasis\+\_\+grid.\+F90.
