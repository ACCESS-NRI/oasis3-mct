...
It is important that the coupled model components be compiled with the same compilers and system software than the OASIS3-MCT library itself.
...
\item {\tt CDF\_64BIT\_DATA} : to allow choice of {\tt cdf5} for {\tt \$NCDFTYP} keyword, see section \ref{subsec_namcouplefirst}.
