...
\item  {\tt static-libs-fortran =} static oasis libraries for fortran only (default)
\item  {\tt shared-libs-fortran =} shared (dynamic) oasis libraries for fortran only
\item  {\tt static-libs         =} static oasis libraries including fortran and c-bindings
\item  {\tt shared-libs         =} shared (dynamic) oasis libraries including fortran and c-bindings
...
The following targets have been used historically to compile oasis for Fortran 
...
The different examples can be launched with the {\tt Makefile} in
directory {\tt /pyoasis} using targets {\tt examples, examples\_f
  examples\_c} to run respectively python, Fortran and C examples.
