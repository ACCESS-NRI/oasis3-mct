...
\vspace{1.5cm}
The development of this new version of OASIS, OASIS3-MCT\_6.0 has been
possible thanks the following fundings:
\begin{itemize}
\item  Agence Nationale de la Recherche - France 2030 as part of the PEPR TRACCS programme under grant number ANR-22-EXTR-0006
\\item EU project IS-ENES3 - Infrastructure for the European Network for Earth System modelling - Phase 3, GA \#824084
\item EU project OptimESM, Horizon Europe research and innovation programme, GA \#101081193
\end{itemize}
\vspace{0.5cm} 
