...
Note that with releases earlier than OASIS3-MCT\_5.2 (2022/11/02), it was not allowed to associate more than one grid to one
partition (this could cause problems with the global {\tt CONSERV} operation).
