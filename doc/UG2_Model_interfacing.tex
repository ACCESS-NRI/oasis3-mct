...
\label{sec_deploy}
ICICICICI
Since OASIS3-MCT\_3.0 version, coupling exchanges between components and
...
Practical examples of how to use the OASIS3-MCT library are also given
in {\tt examples/tutoria\_communication},  and {\tt examples/regrid\_environment} (see sections \ref{subsec_tutorial} and \ref{subsec_regrid}). 
