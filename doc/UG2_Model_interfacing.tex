...
The python wrapper functions, which are briefly described hereafer, can be all tested in {\tt /pyoasis} with {\tt make wrappertest}. To run all tests including python, C and fortran examples from {\tt pyoasis/examples}, use {\tt make test}.
