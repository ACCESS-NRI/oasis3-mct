...
\section{Changes between current master OASIS3-MCT version and OASIS3-MCT\_4.0}
...
\item The {\tt CHECKIN} and {\tt CHECKOUT} log file output was updated to include more diagnostics as well as mask, area, and fraction weighted means and sums.
...
\item New {\tt GSSPOS} and {\tt BSSPOS} for global CONSERV
