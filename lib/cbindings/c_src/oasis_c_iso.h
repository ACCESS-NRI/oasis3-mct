...
void oasis_put_with_frac_iso_double(const int* var_id, const int* kstep, const int* size1, const int* size2, const int* size3, const double* fld1, const double* fracwgt, int* kinfo, const bool* write_restart);
...
void oasis_put_with_frac_iso_float(const int* var_id, const int* kstep, const int* size1, const int* size2, const int* size3, const float* fld1, const float* fracwgt, int* kinfo, const bool* write_restart);
