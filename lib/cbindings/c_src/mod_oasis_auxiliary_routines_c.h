...
void get_multi_intracomm_iso(int* new_comm, const int* n, char** cdnam, int* root_ranks, int* error);
...
void get_multi_intracomm(int* new_comm, const int n, char** cdnam, int* root_ranks, int* error);
